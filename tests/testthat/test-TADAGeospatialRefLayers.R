test_that("TADA_UpdateTribalLayers writes shapefiles, caches signature, and skips when unchanged", {
  ...
  expect_message(suppressWarnings(TADA_UpdateTribalLayers()), "updated\\.", fixed = FALSE)
  ...
  expect_message(suppressWarnings(TADA_UpdateTribalLayers()), "unchanged — skipping write\\.", fixed = FALSE)
  ...
  expect_message(suppressWarnings(TADA_UpdateTribalLayers()), "AKAllotments.shp updated\\.", fixed = FALSE)
