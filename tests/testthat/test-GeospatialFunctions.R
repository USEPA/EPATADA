...
# Local synthetic fixture for fast, deterministic tests.
# Includes all columns needed by TADA_FindNearbySites branches tested below.
nearby_fixture <- tibble::tibble(
  ResultIdentifier = c("R1", "R2", "R3", "R4"),
  TADA.MonitoringLocationIdentifier = c("ML1", "ML2", "ML3", "ML4"),
