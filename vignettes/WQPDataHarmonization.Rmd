...
```{r}
# Here is an example for multiple tribal nations with data in WQX. 
...
# original data retrieval call, takes a bit to run
...
# Results from the example above are stored in the TADA package. Load the data:
data(TribalNations)
TADAProfile <- TribalNations
