...
-   ?AboveNationalWQXUpperThreshold
    ...
    -   When clean = FALSE, the following column is added to your
        dataframe: AboveNationalWQXUpperThreshold. This column flags rows with
...
-   ?BelowNationalWQXLowerThreshold
    ...
    -   When clean = FALSE, the following column is added to your
        dataframe: BelowNationalWQXLowerThreshold. This column flags rows with
...
TADAProfileClean9 <- BelowNationalWQXLowerThreshold(TADAProfileClean8, clean = TRUE)
```
