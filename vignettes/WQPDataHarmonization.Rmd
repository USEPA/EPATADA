...
list.of.packages <- c("plyr", "data.table", "dplyr", "grDevices", "magrittr", "stringr", "utils", "RColorBrewer", "stats", "gganimate", "gifski", "lubridate", "maps", "remotes", "rmarkdown")
...
If you have any issues loading the remotes library using the code above, or 
installing TADA or other packages in the code chunk below,
uncomment the line below to install the "remotes" package specifying the
repo. You must load the remotes library before installing TADA or
...
Uncomment the lines below to install latest version of dataRetrieval, 
ggplot2, usmap, and TADA from GitHub.
...
#libraries loaded straight from GitHub instead of CRAN (see last two code chunks)
