...
The following code (un-comment) will also install any packages you do not have, and
load all packages required to run this vignette into your R session.

```{r, results = 'hide', message = FALSE, warning = FALSE}
# list.of.packages <- c("plyr", "data.table", "dplyr", "magrittr", "stringr", "maps","utils", "RColorBrewer", "stats", "lubridate", "remotes", "dataRetrieval", "ggplot2", "sf")
