...
TADAProfileClean1=autoclean(TADAProfileClean)
...
TADAProfileClean4=WQXTargetUnits(TADAProfileClean3, convert=TRUE)
```
...
TADAProfileClean7=AboveNationalWQXUpperThreshold(TADAProfileClean6, clean=TRUE)
TADAProfileClean8=BelowNationalWQXUpperThreshold(TADAProfileClean6, clean=TRUE)
...
```{r}
TADAProfileClean15=HarmonizeData(TADAProfileClean14, transform=TRUE)
```
