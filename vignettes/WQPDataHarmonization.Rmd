...
MonitoringLocationTypeName has two values: River/Stream and Well. In this example, 
we show how a user could leverage this function to remove specific values from their
dataframe if desired.

```{r}
# Remove well sample results
