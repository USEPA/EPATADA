...
list.of.packages <- c("plyr", "data.table", "dataRetrieval", "dplyr", "ggplot2", "grDevices", "magrittr", "stringr", "utils", "RColorBrewer", "stats", "lubridate", "remotes", "gganimate", "gifski", "maps")
...
#redraw map with after all rows with invalid LAT/LONG data are removed
map()
...
dataframe. We'll start with ActivityTypeCode.
