...
This example includes monitoring data collected from Jan 2013 to present
...
# if needed, change the sign for all data for sites flagged as outside the USA
...
unique(TADAProfileClean15$TADA.ResultMeasureValueDataTypes.Flag)

# review if any remaining result values are NA
sum(is.na(TADAProfileClean15$TADA.ResultMeasureValue))

# Filter down to only numeric data. Remove "Text","Coerced to NA","ND or NA"  
TADAProfileClean16 <- dplyr::filter(TADAProfile, 
