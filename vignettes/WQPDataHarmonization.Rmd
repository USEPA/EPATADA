...
#Alternatively, use TADA readWQPwebservice function to read in a web service call for any WQP profile
new_fullphyschem_WQPprofile <- readWQPwebservice("https://www.waterqualitydata.us/data/Result/search?countrycode=US&statecode=US%3A49&siteid=UTAHDWQ_WQX-4925610&startDateLo=01-01-2015&startDateHi=12-31-2016&mimeType=csv&zip=no&sorted=yes&dataProfile=fullPhysChem&providers=NWIS&providers=STEWARDS&providers=STORET")
```
