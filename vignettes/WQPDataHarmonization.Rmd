...
```{r}
# uncomment below if you would like to review differences between the profiles you get using readWQPdata vs. TADAdataRetrieval. This is because TADAdataRetrieval automatically joins in other data from different WQP profiles, and does some additional data cleaning as part of the data retrieval process
