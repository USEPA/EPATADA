...
list.of.packages <- c("plyr", "data.table", "dataRetrieval", "dplyr", "ggplot2", "grDevices", "magrittr", "stringr", "utils", "RColorBrewer", "stats", "lubridate", "devtools")

new.packages <- list.of.packages[!(list.of.packages %in% installed.packages()[,"Package"])]
if(length(new.packages)) install.packages(new.packages)
```

Load the devtools library before installing TADA or dataRetrieval from
GitHub
...
```{r, results = 'hide', message = FALSE, warning = FALSE}
# devtools::install_github(repo = "USGS-R/dataRetrieval", dependencies=TRUE)
devtools::install_github(repo = "USEPA/TADA", dependencies=TRUE)
```
