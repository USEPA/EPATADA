...
See ?TADABigdataRetrieval for more details. WARNING, some of the examples
...
View(Unique_InvalidCoordinateFlags)
...
TADAProfileClean19_removeOutliers <-
  dplyr::filter(TADAProfileClean19, TADA.ResultMeasureValue <= 89)
