...
auto_assign option as a quick get around to needing to fill out the table
...
MT.Criteria_user_supplied <- TADA_DefineCriteriaMethodology(
  ...
  org_id = "MTDEQ",
  auto_assign = FALSE, # indicates a blank template to start, the returning table only contains user supplied criteria
  displayUniqueId = TRUE,
  epa304a = TRUE,
  excel = FALSE
  # uncomment to run the excel file
...
on the auto_assign option (if it was successfully crosswalked.).

Note: If a user has an updated list of use names that have been applied to and have chosen to apply the auto_assign = TRUE input, they should also provide a useAURef input. Otherwises the uses will be pulled in from the prior ATTAINS assessment cycle.
...
MT.Criteria_user_supplied_autofill <- TADA_DefineCriteriaMethodology(
  ...
  criteriaMethods = criteria_table, # user supplied table - all rows are kept from this table
  org_id = "MTDEQ",
  auto_assign = TRUE, useAURef = MT.UseAURef_with_WaterUseRef, # indicates a blank template to start, the returning table only contains user supplied criteria
  displayUniqueId = FALSE,
  epa304a = TRUE,
  excel = FALSE
  # uncomment to run the excel file
...
MT.Criteria_user_supplied_autofill2 <- TADA_DefineCriteriaMethodology(
  ...
  criteriaMethods = criteria_table, # user supplied table - all rows are kept from this table
  org_id = "MTDEQ",
  auto_assign = TRUE, # indicates a blank template to start, the returning table only contains user supplied criteria
...
provide a MLSummaryRef file function input and turn the auto_assign option
