...
remotes::install_github("USEPA/EPATADA",
  ref = "update-mod-3-alt-option-vignette",
  dependencies = TRUE
)
```
...
4)  (Recommended) Go through the step-by-step review process with the 3
    TADA crosswalk reference file generation for TADA_ParametersForAnalysis,
    TADA_UsesForAnalysis, and TADA_MLSummaryRef. This vignette
