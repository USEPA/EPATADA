...
## Option B: View EPA304a Recommended Standards

User can choose to view the full list of EPA304a standards that has been filled out in TADA format for most priority WQP Characteristic Name by including "USEPA" as part of the org_id argument input.
...
If a user is only interested in TADA.CharacteristicName(s) that are in their WQP data frame, user can provide their .data in TADA_DefineCriteriaMethodology. Any EPA304a criteria not found for any TADA.CharacteristicName will show up as an empty row. Users can choose to fill this value out as desired or leave this row unfilled/removed.
...
Users can also choose to append epa304a recommended standards to their criteria table by including "USEPA" in the org_id.
