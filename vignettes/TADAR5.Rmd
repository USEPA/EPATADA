...
R5Profile2 <- TADA_AnalysisDataFilter(R5Profile, clean = FALSE)

FieldValues_AnalysisFlag <- TADA_FieldValuesTable(R5Profile2, field = "TADA.UseForAnalysis.Flag")

TADA_FieldValuesPie(R5Profile2, field = "TADA.UseForAnalysis.Flag")
```
