...
below, no crosswalk in your ParamRef2 was provided, so NCTC_ParamRef_Manual2 will
...
NCTC_ParamRef_Manual2 <- TADA_CreateParamRef(
  Data_NCTC,
  org_id = c("MDE_EASP"),
  paramRef = ParamRef2,
  fillBy = "All"
...
all ATTAINS use_names (see the "IncludeOrExclude" column). Later in the
...
rows as needed if the parameter applies to multiples uses.

In the example below, we can see "PH" was not a prior ATTAINS parameter
name for MDE_EASP (see ATTAINS.FlagUseName column in NCTC_UseParamRef).
