...
R5ProfileClean1 <- TADA_FlagSpeciation(R5ProfileClean1, clean = "invalid_only")

R5ProfileClean1 <- TADA_FlagResultUnit(R5ProfileClean1, clean = "invalid_only")
```
...
# DO_SCM_Pie <- TADA_FieldValuesPie(DO_R5ProfileClean8, field = "SampleCollectionMethod.MethodName")
# 
# DO_SCM_Pie

# Create table for SampleCollectionMethod.MethodName for Dissolved Oxygen (DO results)
FieldValuesTable_DO_scm <- TADA_FieldValuesTable(DO_R5ProfileClean8, field = "SampleCollectionMethod.MethodName")
```
