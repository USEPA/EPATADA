...
footer: "EPATADA, dataRetrieval, nhdplusTools, StreamCatTools, hydroloom, spsurvey, spmodel, SSN2"
---
...
# (30 mins) Preparing Data for Analysis 

## (15 mins) Preparing Water Quality Portal (WQP) data for analysis using EPATADA
...
This is an abbreviated intoduction to key TADA Module 1 WQP Data Discovery and Cleaning functions. Additional functions and a more detailed example workflow is available [here](https://usepa.github.io/EPATADA/articles/TADAModule1.html).
