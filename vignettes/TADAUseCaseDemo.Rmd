...
data <- TADA_DataRetrieval(startDate = params$startdate, 
                           endDate = params$enddate, 
                           applyautoclean = TRUE,
                           huc = as.list(el(strsplit(params$huc, ","))),
                           characteristicName = params$characteristicname)
```
...
```{r Filter by Assessment Unit Identifier}
# Import data from WQP
...
water data. The **TADA_AnalysisDataFilter** function can assist in
...
combinations of fields in order to identify a result as groundwater.
