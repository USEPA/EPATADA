---
title: "TADA Module 3A: Associating WQP Characteristic Names with Applicable ATTAINS or EPA 304(a) Criteria Search Tool (CST) Parameter and Use Names"
format: html
editor: visual
author: "TADA Team"
date: "`r Sys.Date()`"
...
sections, for demonstration purposes, we will focus only on Montana. The
...
Now, if MTDEQ, already has a filled out/partially filled out criteria methods table, let's provide this as an argument input. Users will be warned if there are additional WQP characteristics that are not captured in their user supplied table.
