...
ATTAINS.UseName(s) are applicable to their analysis. The default
functionality is to "Include" all ATTAINS use_names (see the
...
AU level of summary, AUML and AU_UsesRef are required. We recommend
reviewing the ExampleMod2Workflow vignette for more in depth information
on this crosswalk. We will load these example reference tables into this
vignette.
