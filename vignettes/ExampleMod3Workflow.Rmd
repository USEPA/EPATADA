...
## Join Criteria Table to Your WQP Data

Now that your criteria table is ready, the next step is to join it to your WQP data frame.
If you are only interested in performing a monitoring location level analysis, you can provide just
the WQP data and criteria table. 

First, join the criteria table to your WQP data frame. The criteria table will automatically be joined by the best match of either TADA.ComparableDataIdentifier or by combinations of TADA.CharacteristicName, TADA.ResultSampleFractionText, and TADA.MethodSpeciationName.In this example, all characteristic and/or parameter.
