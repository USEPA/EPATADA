...
utils::data(Data_MT_UseAURef_Water)
...
MT.UseParamRef.with.useAURef <- TADA_CreateUseParamRef(
  ...
  org_id = c("MTDEQ"),
  paramRef = MT.ParamRef.Final,
  useAURef = Data_MT_UseAURef_Water, # uses will come from the user supplied reference table produced in ExampleMod2Workflow.Rmd
  auto_assign = TRUE,
  excel = FALSE
)
```
...
# Load the dataset
utils::data("Data_MT_UseAURef_Water", package = "EPATADA")
