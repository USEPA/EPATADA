...
In the next section, we’ll also use the AUMLRef and AU_UsesRef crosswalk outputs from [TADAModule2.Rmd] to show how to work with assessment unit–level analysis.

First, join the criteria table to your WQP data frame. The criteria table will automatically be joined by the best match of either TADA.ComparableDataIdentifier or by combinations of TADA.CharacteristicName, TADA.ResultSampleFractionText, and TADA.MethodSpeciationName.
