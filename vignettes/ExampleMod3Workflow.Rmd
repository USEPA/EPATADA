...
users through how to create WQP and ATTAINS crosswalks that are neede to
...
-   Define and summarize your spatial level of analysis for uses and
    ...
    and capture any unique site-specfic WQS criteria.

These functions are designed to be flexibley so users from states,
