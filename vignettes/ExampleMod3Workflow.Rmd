...
QUESTION: Initially, we were thinking we would include all combinations
of crosswalks (from user supplied and from an auto_assign method), but
now we are leaning towards full prioritization of the user-supplied
crosswalk.
