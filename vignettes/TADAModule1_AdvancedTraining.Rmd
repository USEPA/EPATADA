...
or WQP GUI-downloaded data frame into the R package. However, column
...
formatted. Let's add any suspect results to the removed data frame for
later review.
...
comp_data_id <- "PH_NA_NA_STD UNITS"
