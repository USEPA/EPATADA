...
representations of each entities assessment units as well as their assigned
designated uses, their most recent EPA reporting category 
(i.e., their impairment status), their impaired designated uses, and the
parameter(s) causing the impairment.

Within an assessment unit, the water quality criteria or thresholds used
to assess water quality typically remain the same and all water features 
are assessed as one entity (although there are some exceptions). 
Depending on the state or tribe, these assessment units can be a specific
points along a waterbody such as a river or lake, a river reach, 
an entire waterbody such as a river or lake, or even an entire watershed. 
In other words, assessment units can take the form of point, line, and area
