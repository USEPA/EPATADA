...
```{r install_remotes, eval = FALSE, results = 'hide'}
...
```{r install_TADA, eval = FALSE, results = 'hide'}
remotes::install_github("USEPA/TADA",
  ref = "vignette_visualizations",
  dependencies = TRUE
)
```
...
```{r fig.cap="ATTAINS Assessment Units and WQP Monitoring Locations", fig.height=7}
