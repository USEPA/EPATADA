...
```{r demo.user, results = 'hide', eval = T}
...
```{r TADA_CreateAUMLCrosswalk, eval = T}
...
```{r view.map}
map <- TADA_ViewATTAINS(MT.AUMLRef, ref_icons = TRUE)

htmlwidgets::saveWidget(map, file="vignettes/images/TADA_ViewATTAINS.html")
```
