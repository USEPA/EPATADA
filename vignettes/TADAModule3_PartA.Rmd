...
As the ATTAINS Parameter Names are more general than the
TADA Comparable Data Identifiers, it is not possible at this time to automate the crosswalk. TADA_CreateParamRef() creates a template which
