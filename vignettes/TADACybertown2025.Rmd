...
```{r install EPATADA develop, results = 'hide', eval = F}
remotes::install_github("USEPA/EPATADA", ref = "develop", dependencies = TRUE)
```

```{r install EPATADA dev branch, results = 'hide', include = F}
remotes::install_github("USEPA/EPATADA", ref = "harmonize", dependencies = TRUE)
```
