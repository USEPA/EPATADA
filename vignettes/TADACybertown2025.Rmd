...
value (STV) for the bacteria samples. The STV approximates the 90th
percentile of the water quality distribution and is intended to be a
value that should not be exceeded by more than 10 percent of the samples
taken. The table summarizes the magnitude component of the
...
We will apply the recommendation 2, STV for ESCHERICHIA COLI of 320
CFU/100mL.
