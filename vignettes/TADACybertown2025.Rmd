...
WQP_Shepherdstown_clean_2 <- WQP_Shepherdstown_clean %>%
  dplyr::filter(TADA.CensoredData.Flag != "Conflict between Condition and Limit")
```
...
We will also filter the data to remove any remaining NAs.
...
compid_1 <- unique(WQP_Shepherdstown_clean$ComparableDataIdentifier)
