...
`TADA_ConvertSpecialChars` removes rows where the result value is not numeric to
...
`TADA_RetainRequired` removes extra columns. Enter ?TADA_RetainRequired into the console for more details.
