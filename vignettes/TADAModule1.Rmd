...
The TADA_TribalOptions function can be used to narrow down options for
use with tribe_name_parcel. See ?TADA_TribalOptions for more info.
...
examples above, using tigris::native_areas to acquire Census Bureau
spatial data:
