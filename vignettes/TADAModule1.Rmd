...
This vignette walks through how to use the EPATADA R Package to discover
...
Filter down to only include data that is numeric in the `TADA.ResultMeasureValue` column. This removes data where the `TADA.ResultMeasureValueDataTypes.Flag` = `Text` or 
`NA - Not Available`.
