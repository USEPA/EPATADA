...
we review flagged Quality Control (QC) values using the
...
Before we remove the QC samples/measurements from this dataset to prepare for analyses,
let's run **TADA_PairReplicates** to see if any replicates in this dataframe can be 
paired with their original (parent) samples/measurements.

```{r}
TADAProfileClean4 <- TADA_PairReplicates(TADAProfileClean4)
```
...
TADAProfileClean4 <- TADA_FindQCActivities(TADAProfileClean4, 
                                           clean = TRUE)
