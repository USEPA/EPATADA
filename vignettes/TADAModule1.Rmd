...
description: An overview of all TADA Module 1 functions and a recommended workflow.
editor_options: 
...
```{r for-development-only, echo = F, eval = F, results = 'hide', message = FALSE, warning = FALSE}
