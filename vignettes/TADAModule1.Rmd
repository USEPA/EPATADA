...
automatically runs the TADA **TADA_AutoClean** and **TADA_ConvertSpecialChars**
...
any contents in the WQP-served columns (enter *?TADA_ConvertSpecialChars* and
*?TADA_AutoClean* into the console for more details). Instead, they add new
