...
```{r fieldValues_all, fig.width=6, fig.height=3, fig.fullwidth=TRUE}
...
```{r TADA_FindQCActivities, fig.width=6, fig.height=4, fig.fullwidth=TRUE}
...
```{r MeasureQualifierCodeReview, fig.width=6, fig.height=4, fig.fullwidth=TRUE}
...
# Removes rows with any remaining NA's in the TADA.ResultMeasureValue column
...
```{r TADA_FieldValuesTable_Pie_char, fig.width=6, fig.height=4, fig.fullwidth=TRUE}
...
```{r ComparableDataIdentifier_stats_and_histogram, fig.width=10, fig.height=6, fig.fullwidth=TRUE}
...
TADAProfileCleanTP <- dplyr::filter(TADAProfileClean5, TADA.ComparableDataIdentifier == "TOTAL PHOSPHORUS, MIXED FORMS_UNFILTERED_AS P_UG/L")
...
```{r boxplot, fig.width=10, fig.height=6, fig.fullwidth=TRUE}
