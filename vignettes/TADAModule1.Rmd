...
TADA.ResultMeasureValueDataTypes.Flag = "Text","Coerced to NA",or "Blank".

```{r filter_out_NAs}
# Removes rows where the result value is not numeric. Specifically, removes rows with "Text","Coerced to NA", or "Blank" in the TADA.ResultMeasureValueDataTypes.Flag column, or NA in the TADA.ResultMeasureValue column.
