...
remotes::install_github("USEPA/TADA",
  ref = "351-update-tada_findcontinuousdata",
  dependencies = TRUE
)
```
...
The **TADA_FlagContinuousData** function checks for and removes
...
the following code in the console: ?TADA_FlagContinuousData
...
# TADAProfile_aggcont <- TADA_FlagContinuousData(TADAProfileClean3, clean = FALSE, flaggedonly = TRUE)
```
