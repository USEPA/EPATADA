...
-   ?**TADA_FindPotentialDuplicatesBetweenOrgs**
-   ?**TADA_FindPotentialDuplicatesWithinOrg**


```{r PotentialDuplicateRowID}
TADAProfileClean3 <- TADA_FindPotentialDuplicatesBetweenOrgs(TADAProfileClean3, dist_buffer = 100)

TADAProfileClean3 <- TADA_FindPotentialDuplicatesWithinOrg(TADAProfileClean3, handling_method = 'pick_one')
```
