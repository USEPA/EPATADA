...
```{r WQX_Thresholds}
TADAProfileClean3 <- TADA_FlagResultAboveThreshold(TADAProfileClean2, clean = TRUE)

TADAProfileClean3 <- TADA_FlagResultBelowThreshold(TADAProfileClean3, clean = TRUE)
```
...
TADA_FindQualityControlData function.

```{r TADA_FindQualityControlData}
# Remove all QC samples using the TADA_FindQualityControlData function:
# enter ?TADA_FindQualityControlData into the console for more information
TADAProfileClean4 <- TADA_FindQualityControlData(TADAProfileClean3, clean = TRUE)
