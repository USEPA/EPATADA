...
fieldValuesTable(TADAProfileClean13, "ActivityTypeCode")
fieldValuesPie(TADAProfileClean13, "ActivityTypeCode")
```
...
# regenerate table and pie chart
fieldValuesPie(TADAProfileClean15, "MeasureQualifierCode")
```
...
fieldValuesTable(TADAProfileClean18, "TADA.CharacteristicName")
```
