...
package functions. It joins four WQP profiles: Site,
...
TADA.ResultMeasureValueDataTypes.Flag = "Text","Coerced to NA",or "NA - Not Applicable".

```{r filter_out_NAs}
# Removes rows where the result value is not numeric. Specifically, removes rows with "Text","Coerced to NA", or "NA - Not Applicable" in the TADA.ResultMeasureValueDataTypes.Flag column, or NA in the TADA.ResultMeasureValue column.
