...
vignette: >
  ...
  %\VignetteIndexEntry{Tools for Automated Data Analysis (TADA) Module 1: Water Quality Portal Data Discovery and Cleaning}
...
```{r FilterFieldReview, fig.width=6, fig.height=2, fig.fullwidth=TRUE}
...
```{r FilterParFieldReview, fig.width=6, fig.height=2, fig.fullwidth=TRUE}
...
```{r ComparableDataIdentifier_stats_and_histogram}
...
TADA::TADA_boxplot(TADAProfileClean19)
...
TADAProfileClean19_removeOutliers <- dplyr::filter(TADAProfileClean19, TADA.ResultMeasureValue <= 86.5)

```

Regenerate histogram and box plot.

```{r histogram_and_boxplot_final}

# regenerate histogram
TADA_hist(TADAProfileClean19_removeOutliers)
