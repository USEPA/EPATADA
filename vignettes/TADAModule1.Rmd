...
Note that upon download using **TADAdataRetrieval**, all depth columns
...
**fieldValuesTable** or **fieldValuesPie**. We'll start with
ActivityTypeCode.
...
*ResultDetectionConditionText* and *DetectionQuantitationLimitTypeName*.
This utility function is automatically run within the TADAdataRetrieval
...
Next, we can revisit the **fieldCounts** function at the characteristic
...
Now, we'll use **fieldValuesTable** and **fieldValuesPie** at the
