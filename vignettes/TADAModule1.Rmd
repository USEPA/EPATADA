...
fieldCounts(TADAProfileClean13)

# create object of table
fieldCounts_Table <- fieldCounts(TADAProfileClean13)
...
fieldValuesTable(TADAProfileClean13, field = "ActivityTypeCode")
fieldValuesPie(TADAProfileClean13, field = "ActivityTypeCode")
```
...
fieldValuesTable(TADAProfileClean14, "ActivityTypeCode")
fieldValuesPie(TADAProfileClean14, "ActivityTypeCode")
...
fieldValuesPie(TADAProfileClean14, "MeasureQualifierCode")
```
...
# regenerate table and pie chart
fieldValuesPie(TADAProfileClean15, field = "MeasureQualifierCode")
```
...
fieldValuesTable(TADAProfileClean18, field = "TADA.CharacteristicName")
```
...
```{r fieldCounts_char}
fieldCounts(TADAProfileClean18, display = "most", characteristicName = "TOTAL PHOSPHORUS, MIXED FORMS")
```
...
fieldValuesTable(TADAProfileClean18, field = "SampleCollectionMethod.MethodName",  characteristicName = "TOTAL PHOSPHORUS, MIXED FORMS")
fieldValuesPie(TADAProfileClean18, field = "SampleCollectionMethod.MethodName",  characteristicName = "TOTAL PHOSPHORUS, MIXED FORMS")
...
TADA_hist(TADAProfileClean19, id_col = "TADA.ComparableDataIdentifier")
