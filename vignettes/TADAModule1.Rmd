...
new column, *TADA.Media.Flag*, identifying if the result should
...
you would like to see all results with the *TADA.Media.Flag*
column, you can uncomment the example where clean = FALSE.

If you are not interested in using **TADA_MediaFilter**, but
