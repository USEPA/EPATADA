...
-   **TADA_ConvertResultUnits** - unifies result and detection limit units for easier quality control and review.
...
We found over 100 replicates in this dataframe that have a paired parent sample/measurement.
