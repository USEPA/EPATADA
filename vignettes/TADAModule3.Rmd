...
# User can now save this reference file to be used as an input in future assessments.
Co_ParamRef2 <- TADA_CreateParamRef(temp, paramRef = ParamRef, excel = TRUE, overwrite = TRUE)

# Excel creation is now also optional.
...
Co_ParamRef5 <- TADA_CreateParamRef(temp, validate = TRUE, excel = FALSE)
