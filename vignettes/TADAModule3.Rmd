...
Creates a blank template of ATTAINS.ParameterName which needs crosswalk. Users should specify the name(s) of their orgs that will be used for
assessment. 
...
ParamRef <- dplyr::mutate(NCTC_ParamRef, ATTAINS.ParameterName = dplyr::case_when(TADA.CharacteristicName == "NITRATE" ~ "NITROGEN, TOTAL",
