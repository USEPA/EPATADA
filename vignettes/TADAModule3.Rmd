...
```{r, eval = FALSE}
# can this be made easier to read? set up as DT?
...
organization specified in the "organization_name" column has listed this
parameter as a cause in prior assessment cycles. It also flags rows
where the TADA.ComparableDataIdentifier as not been assigned an ATTAINS
parameter name.
