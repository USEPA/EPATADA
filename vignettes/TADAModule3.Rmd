...
See Module 1 Workflow.R script for more information on the steps
on creating this example data frame with TADA flagging, harmonization
and autoclean processes.
...
utilizes the EPA304a.PollutantName column created in TADA_CreateParamRef().
