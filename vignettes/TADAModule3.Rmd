...
it does not auto-populate, but the goal is that if states share their
...
appropriate to define for assessment. The default is to "Include" all
use_names that will need a definition for magnitude criteria and
methodology. If a use_name is not appropriate, users should choose
"Exclude".

For any ATTAINS parameter name(s) that have not been used by this org in
prior assessment cycles, users will be responsible for inputting
