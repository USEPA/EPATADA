...
make the edits on the excel spreadsheet file created in the downloads
folder.

\*If users are only interested in the epa304a standards, we should make
this function able to run without having to create the 3 reference
tables.
