...
Co_dataframe_ATTAINS2 <- Co_dataframe_ATTAINS$TADA_with_ATTAINS
unique(Co_dataframe_ATTAINS2$OrganizationFormalName)
unique(Co_dataframe_ATTAINS2$ATTAINS.organizationname)
unique(Co_dataframe_ATTAINS2$OrganizationIdentifier)
