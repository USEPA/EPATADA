...
TADA_ParamRef <- TADA_CreateParamRef(TADA_dataframe, overwrite = TRUE)

TADA_ParamUseRef <- TADA_CreateParamUseRef(ParamRef = ParamRef, overwrite = TRUE)
# User can either save the excel file of the edits they made there, or read it in as a dataframe to R and provide it as a ref argument in the next steps

## IMPORTANT - Need to make sure any formulas are the right type when reading xlsx file into r.
