...
their assessment methods under . It does not constitute current Agency
policy or regulation requirements. This tool is not to be solely used
for decisionmaking process. Module 3 integration of WQS for assessments
is not a regulation and does not impose legally binding requirements on
EPA or the States in reporting water conditions under biannual reports
of the CWA.
...
TADA_dataframe_test <- TADA_dataframe4 %>%
...
```{r}
temp <- data.frame(TADA_with_ATTAINS$TADA_with_ATTAINS)
