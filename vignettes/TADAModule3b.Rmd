...
Based on the parameter and use methodology for assessment, we will determine
the number of individual excursions for each based on the defined magnitudes.

```{r}
NCTC_Excusions <- TADA_MagnitudeSummary(
  Data_NCTC,
  StandardsRef = NCTC_magnitude,
  overwrite = TRUE
)
```
