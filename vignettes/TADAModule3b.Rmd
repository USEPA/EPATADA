...
NCTC_SpatialRef <- TADA_CreateSpatialRef(Data_NCTC, excel = TRUE, overwrite = TRUE)
```
...
```{r}
GetATTAINSRef <- TADA_GetATTAINS(Data_NCTC)
SitesAURef <- GetATTAINSRef$TADA_with_ATTAINS
