...
We are interested in hearing feedback from users on the new WQX 3.0
profiles and WQP beta web services. In addition, please share feedback
on how we can further assist you with your transition from WQX 2.2 to
WQX 3.0. If you notice issues with TADA workflows when we start our
updates to transition the package to WQX 3.0, please let us know.
