...
function](https://en.wikipedia.org/wiki/Probability_density_function "Probability density function")
(pdf) of a Normal N(0,σ^2^) Population. Attribution: Jhguch at
en.wikipedia, [CC BY-SA
