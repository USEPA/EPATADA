...
``` r
TADA_GetMeasureQualifierCodeRef(download_only = FALSE, refresh = FALSE)
```
...
- download_only:
  ...
  to download the latest Result Measure Qualifier reference table
...
data.frame with TADA.MeasureQualifierCode.Flag added
