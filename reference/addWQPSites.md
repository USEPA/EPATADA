...
unit/monitoring location crosswalk. If TADA.AURefSource is not included
or the user does not want to display assessment unit identifier
information via the icons (by setting ref_icons = FALSE), solid black
circle markers are used to display all WQP sites.
...
- .data:
  ...
  columns (HRM 1/5/26)). Needs to be in sumdat format or getWQPSiteStats
  will be run.
