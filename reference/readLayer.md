# Read a spatial file from a local folder, optionally crop it by a bounding box, and return it as a sf object readLayer is used within TADA_addPolys and TADA_addPoints
