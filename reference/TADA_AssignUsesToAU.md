...
A data frame with all the MonitoringLocationIdentifier Sites for each
defined AU.

## Details

This function is mainly designed to assist with pulling existing Uses
that have been entered into ATTAINS in the prior ATTAINS cycle (most
recent assessment).
