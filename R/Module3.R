...
#          dplyr::distinct() %>%
#          dplyr::left_join(criteria.convert, by = dplyr::join_by(TADA.CharacteristicName, TADA.ResultSampleFractionText)) %>%
#          dplyr::left_join(wqx.ref, by = dplyr::join_by(TADA.ResultMeasure.MeasureUnitCode, TADA.Target.ResultMeasure.MeasureUnitCode)) %>%
#          dplyr::select(TADA.CharacteristicName, TADA.ResultMeasure.MeasureUnitCode, TADA.MethodSpeciationName,
...
# 
# 
#        convert.data2 <- TADA_ConvertResultUnits(convert.data, ref = unit.ref)
# 
# 
#      }
# 
...
# refnames <- names(ref)
# 
# unitrefnames <- names(unit.ref)
# 
# setdiff(unitrefnames, ref)
