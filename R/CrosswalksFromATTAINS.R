...
#' and MS_LOCATION_ID is required. Additional columns, MONITORING_DATA_LINK_TEXT, containing a URL 
#' or "; " separated URLs linking to information about the Monitoring Location, and MS_ORG_ID,
#' containing the WQP organization identifier for the Monitoring Location are optional.Data link 
#' URLS to WQP site pages cannot be automatically generated by this function unless MS_ORG_ID is 
#' provided. When crosswalk = NULL, the crosswalk will be downloaded from ATTAINS. This allows 
#' users to add URLs for the Water Quality Portal Data Site pages to the ATTAINS Assessment Unit 
...
#' 
#' # Alaska example with user supplied crosswalk containing data links
#' ex.user.cw <- data.frame(MS_LOCATION_ID = c("AK_M_1021211_000", "K_M_1021008_000",
#'                                             "AK_M_1021109_013", "AK_M_1021109_013", 
#'                                             "AK_M_1021109_013"),
#'                          MS_ORG_ID = c("AKDECWQ", "AKDECWQ", "AKDECWQ", "AKDECWQ", "AKDECWQ"),
#'                          ASSESSMENT_UNIT_ID = c("ExampleSite1", "ExampleSite2", "ExampleSite3",
#'                                                 "ExampleSite4", "ExampleSite5"),
#'                          MONITORING_DATA_TEXT_LINK = c()
#'                        )
#' 
#' }
#'
