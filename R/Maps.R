...
#       checkForWQPData(tada_attains = TADA_table,
...
#       all_attains <- addAllATTAINS(map = map,
...
#       try(
#         {
#           wqp_sites <- addWQPSites(TADA_nearby,
#                                    map = map,
#                                    icons = images,
#                                    ref_icons = TRUE,
#                                    overlay_groups = overlay_groups
...
#       sumdat <- getWQPSiteStats(TADA_table, attains = TRUE)
#
#       # Basemap for AOI:
