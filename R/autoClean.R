...
#' with a numeric value. If all depth columns contain only NAs, no conversion
...
TADA_AutoClean <- function(.data) {
  ...
  # message("TADA_Autoclean: identifying and copying detection limit data to result value if blank.")
